...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                kk.sendText(msg.to,"Tukang Ngintip Hadir")
                ki.sendText(msg.to,"Tukang Nikung Hadir")
                cl.sendText(msg.to,"Tukang Mojok Hadir")
                kc.sendText(msg.to,"Tukang Baper Hadir")
                ks.sendText(msg.to,"Tukang Ngocok Hadir")
                k1.sendText(msg.to,"Tukang Modus Hadir")
                k2.sendText(msg.to,"Tukang Ngeyel Hadir")
                k3.sendText(msg.to,"Tukang Bully Hadir")
